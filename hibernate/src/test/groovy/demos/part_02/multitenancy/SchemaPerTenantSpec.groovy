package demos.part_02.multitenancy
...
/**
 * - New Transforms @CurrentTenant, @Tenant, @WithoutTenant
 * - Schema-Per-Tenant Improvements
 */
class SchemaPerTenantSpec extends Specification {
    ...
    void 'Wayyy easier to use Schema-Per-Tenant now!'() {
